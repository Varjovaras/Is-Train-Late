...
export async function loader() {
  ...
  const query = `{
    currentlyRunningTrains(where: {operator: {shortCode: {equals: "vr"}}}) {
      trainNumber
      departureDate
      trainLocations(where: {speed: {greaterThan: 150}}, orderBy: {timestamp: DESCENDING}, take: 1) {
        speed
        timestamp
        location
      }
          ...
          >
            ...
            {train.trainLocations !== null && (
              <div className="mt-2">
                ...
                <p>
                  Last Updated:{" "}
                  {new Date(train.trainLocations[0].timestamp).toLocaleString()}
                </p>
                <p>
