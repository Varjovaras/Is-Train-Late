...
import { getCommercialStationArrivals, getLatestCommercialStationName, getNextStation } from "@/lib/utils/trainUtils";
            ...
            {passengerStationTimeTableRows.map((station) => {
                ...
                return (
                    ...
                    >
                        ...
                        <div className="flex-1">{station.station.name}</div>
