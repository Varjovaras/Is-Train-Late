...
export type LongDistanceTrainTypeName = (typeof longDistanceTrainTypeNames)[number];
export type RussianTrafficTrainTypeName = (typeof russianTrafficTrainTypeNames)[number];
